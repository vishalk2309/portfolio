...
export const TABLES = [
  {
    ...
    fields: [
      ...
      { name: "summary", label: "Professional summary (About)", type: "textarea", full: true },
  ...
  },
  {
    ...
    icon: "🗂️",
    listColumns: ["label", "resource_id"],
    orderBy: "sort_order",
    fields: [
      {
        name: "resource_id",
        label: "Belongs to which resource?",
        type: "reftable",
        refTable: "resources",
        refLabel: "title",
        full: true,
      },
      { name: "label", label: "File label (e.g. Chapter 1 – Basics)", type: "text", full: true },
      {
        name: "file_url",
        label: "FREE file — public (if the resource is free)",
        type: "file",
        full: true,
      },
      {
        name: "file_path",
        label: "PAID file — private (if the resource is paid)",
        type: "file",
        bucket: "paid-resources",
        storePath: true,
        full: true,
