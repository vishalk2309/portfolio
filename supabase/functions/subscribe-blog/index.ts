// Supabase Edge Function: subscribe-blog
//
// Adds an email to the blog newsletter list and sends a short confirmation.
//
// Deploy:
//   supabase functions deploy subscribe-blog --no-verify-jwt
//
      ...
      await sendBrevo(
        {
          ...
          to: [{ email }],
          subject: "You're subscribed to the blog",
          htmlContent: `<div style="font-family:system-ui,Segoe UI,Arial,sans-serif;font-size:15px;line-height:1.6;color:#111">
            <p>Thanks for subscribing! You'll get an email whenever a new post goes live.</p>
            <p>— ${senderName}</p>
          </div>`,
        },
        apiKey
